  ...
  return (
    <Box sx={{ maxWidth: 1200, mx: "auto", p: { xs: 2, md: 3 } }}>
      ...
      <Box sx={{ mb: 4, textAlign: "center" }}>
        <Typography variant="h3" component="h1" gutterBottom sx={{ fontWeight: 800, color: "#1a365d" }}>
      ...
      <Grid container spacing={4}>
        ...
        <Grid item xs={12} md={8}>
          ...
          {/* Processing Progress */}
          {processing && (
            <Paper sx={{ p: 3, mt: 3, border: "1px solid", borderColor: "primary.light", bgcolor: "primary.light + '08'" }}>
        ...
        <Grid item xs={12} md={4}>
          ...
          {/* Quick Stats */}
          <Paper sx={{ p: 3, mt: 3, bgcolor: "primary.light + '08'", border: "1px solid", borderColor: "primary.light" }}>
      ...
      {/* Results Display */}
      {decodedImage && (
        <Paper sx={{ p: 4, mt: 4, border: "2px solid", borderColor: "success.main", bgcolor: "success.light + '08'" }}>
          ...
          <Grid container spacing={3}>
            <Grid item xs={12} md={4}>
              <Card sx={{ p: 2, height: "100%" }}>
                ...
                <Typography variant="body1" sx={{ fontFamily: "monospace", bgcolor: "grey.50", p: 2, borderRadius: 1 }}>
